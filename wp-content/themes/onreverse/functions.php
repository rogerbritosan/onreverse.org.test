...
function onreverse_theme_support(){
...
add_action('after_setup_theme','onreverse_theme_support');
...
add_action('init', 'onreverse_menus');
...
add_action('wp_enqueue_scripts', 'onreverse_register_styles');
...
add_action('wp_enqueue_scripts', 'onreverse_register_scripts');

function onreverse_widget_areas(){
    register_sidebar(
        array(
            'before_title' => '',
            'after_title' => '',
...
add_action('widgets_init', 'onreverse_widget_areas');
